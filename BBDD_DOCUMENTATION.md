...
| Procedimiento | IN Parameters | OUT Parameters / Retornos |
|---|---|---|
| **`profesor.materias_crear`** | `p_id_profesor`, `p_nombre`, `p_descripcion`, `p_id_periodo_lectivo` | `p_id_materia`, `p_error` |
| **`profesor.materias_listar`** | `Pn_id_profesor` | `refcursor`, `Pv_error` |
| **`profesor.preguntas_agregar`** | `Pn_id_prueba`, `Pv_texto`, `Pj_opciones`, `Pn_respuesta_correcta`, `Pn_puntaje`, `Pn_tiempo_limite` | `Pn_id_pregunta`, `Pv_error` |
| **`profesor.partidas_iniciar`** | `Pn_id_prueba`, `Pn_id_profesor` | `Pn_id_partida`, `Pv_codigo_acceso`, `Pv_error` |
